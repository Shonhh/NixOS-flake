  ...
  config = lib.mkIf cfg.enable {
    ...
    wayland.windowManager.hyprland.settings = {
      ...
      bind = [
        ...
        "$mod, T, exec, $terminal"
        "$mod, F, exec, $browser"
        "$mod, D, exec, hyprctl dispatch workspace 12 && discord"
        "$mod, S, exec, hyprctl dispatch workspace 11 && spotify"
        "$mod, G, exec, hyprctl dispatch workspace 10 && steam"
        "$mod+Shift, G, exec, hyprctl dispatch workspace 10 && gamescope -w 1920 -h 1080 -W 1920 -H 1080 -r 200 -e -f --xwayland-count 2 --hdr-enabled --hdr-itm-enabled --force-grab-cursor -- steam -noverifyfiles -gamepadui"
